...
/*******************************************************************************
 ** Meta Data Producer for SyncSFTPExportConfigScheduledJob
 *******************************************************************************/
public class SyncSFTPExportConfigScheduledJobMetaDataProducer extends MetaDataProducer<QProcessMetaData>
{
   public static final String NAME = "syncSFTPExportConfigScheduledJob";
   ...
   public QProcessMetaData produce(QInstance qInstance) throws QException
   {
      QProcessMetaData processMetaData = TableSyncProcess.processMetaDataBuilder(false)
         .withName(NAME)
         .withSyncTransformStepClass(SyncSFTPExportConfigScheduledJobTransformStep.class)
         .withReviewStepRecordFields(List.of(
            new QFieldMetaData("sftpExportConfigId", QFieldType.INTEGER).withPossibleValueSourceName(SFTPExportConfig.TABLE_NAME),
